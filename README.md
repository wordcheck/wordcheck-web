...
단어를 외우기 위해 의미 없이 종이에 여러 번 쓰인 단어들을 보면서,  
웹 페이지에서 한번 단어를 입력하는 것으로 나만의 단어장을 만들고 단어장 안에서 재미있는 퀴즈를 만들면  
단어를 좀 더 재미있게 외울 수 있겠다는 생각에 wordCheck 서비스를 기획하게 되었습니다.  
...
- 별 아이콘을 클릭하여 중요한 단어 표시를 할 수 있습니다((5)북마크 기능 참고).
...
- 별 아이콘을 눌러 북마크에 단어를 저장할 수 있습니다.
- 북마크은 로컬 스토리지에 저장되어 오프라인 환경에서도 북마크 단어를 확인할 수 있습니다.
